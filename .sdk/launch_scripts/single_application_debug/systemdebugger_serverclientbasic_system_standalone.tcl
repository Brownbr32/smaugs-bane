...
fpga -file C:/Users/DSmac/workspace/serverClientBasic/_ide/bitstream/design_Client1_wrapper.bit
targets -set -nocase -filter {name =~"APU*"}
...
targets -set -nocase -filter {name =~"APU*"}
source C:/Users/DSmac/workspace/serverClientBasic/_ide/psinit/ps7_init.tcl
ps7_init
ps7_post_config
targets -set -nocase -filter {name =~ "*A9*#0"}
dow C:/Users/DSmac/workspace/serverClientBasic/Debug/serverClientBasic.elf
